...
public final class ConfigFactory {
   ...
   */
  public static Config load(
      ClassLoader loader, ConfigParseOptions parseOptions, ConfigResolveOptions resolveOptions) {
  ...
  /**
   * Equivalent to {@link com.typesafe.config.ConfigFactory#load(ClassLoader, String,
   * ConfigParseOptions, ConfigResolveOptions)} with {@link YamlConfigIncluder#DEFAULT} prepended to
   * {@code parseOptions}.
   *
   * @param loader class loader used to find resources
   * @param resourceBasename resource basename (e.g. {@code application})
  ...
  /**
   * Equivalent to {@link com.typesafe.config.ConfigFactory#defaultApplication(ConfigParseOptions)}
   * with {@link YamlConfigIncluder#DEFAULT} prepended and {@code loader} set via {@link
  ...
  /**
   * Returns the unresolved reference config assembled from all {@code reference.conf} resources on
   * the classpath.
   *
  ...
  /**
   * Returns config from system-property overrides and other highest-priority sources, using {@code
   * loader} for any classpath lookups.
   *
  ...
  /**
   * Equivalent to {@link com.typesafe.config.ConfigFactory#parseURL(URL, ConfigParseOptions)} with
  ...
  /**
   * Equivalent to {@link
   * com.typesafe.config.ConfigFactory#parseApplicationReplacement(ConfigParseOptions)} with {@link
   * YamlConfigIncluder#DEFAULT} prepended.
   *
   ...
   * Equivalent to {@link
   * com.typesafe.config.ConfigFactory#parseApplicationReplacement(ConfigParseOptions)} with {@link
   * YamlConfigIncluder#DEFAULT} prepended to {@code options}.
   *
   * @param options parse options
   * @return optional application replacement config
   */
